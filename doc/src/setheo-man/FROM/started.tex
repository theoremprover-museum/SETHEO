...
%\end{picture}
%\caption{Full fledged XTHEO}\label{fig:whole_thing}
%\end{figure}

\bild{xtheo01.ps}{12cm}{17cm}{Full fledged XTHEO}{fig:whole_thing}

\ssubsection{The Example--Theorem} 
...
%\end{picture}
%jfjfj
%\caption{XTHEO's Main Window}\label{fig:xtheo_main_window}
%\end{center}
%\end{figure}

\bild{win01.ps}{9cm}{15cm}{XTHEO's Main Window}{fig:xtheo_main_window}
...
\ssubsubsection{wasm and inwasm}
...
%\input{ /u1/johann/papers/setheo/man/proof_pic}
%\end{picture}
%jfjfj
%\caption{Proof tree}\label{fig:proof_tree}
%\end{center}
%\end{figure}

\bild{tree01.ps}{9cm}{15cm}{Proof tree}{fig:proof_tree}
